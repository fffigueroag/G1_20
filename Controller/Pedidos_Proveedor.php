...
if ($_SERVER['REQUEST_METHOD'] === 'OPTIONS') {
    ...
    case "InsertPedido":
        ...
        echo json_encode("Pedido de proveedor agregado exitosamente");
    break;
    ...
    case "UpdatePedido":
        ...
        echo json_encode("Pedido de proveedor actualizado exitosamente");
    break;

    case "deletePedido":
    $datos=$pedidos->delete_pedido($body["ID"]);
    echo json_encode("Pedido de proveedor eliminado exitosamente");
    break;
}
?>